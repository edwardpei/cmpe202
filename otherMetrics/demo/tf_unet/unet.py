...
class Unet(object):
    ...
    def predict(self, model_path, x_test, numOfThread = 2):
        """
...
class Trainer(object):
    ...
    def train(self, data_provider, output_path, training_iters=10, epochs=100, dropout=0.75, display_step=1, restore=False, write_graph=False, prediction_path = 'prediction', numOfThread = 2):
        """
